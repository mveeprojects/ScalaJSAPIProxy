let handleContainerButtonClickEvent,onLoadHandler;
(function(){
'use strict';
...
function $p_Lcss_classes_package$__DISPLAY_NONE$lzycompute__T($thiz) {
  if (((((1 & $thiz.Lcss_classes_package$__f_bitmap$0) << 24) >> 24) === 0)) {
    $thiz.Lcss_classes_package$__f_DISPLAY_NONE = "display-none";
    $thiz.Lcss_classes_package$__f_bitmap$0 = (((1 | $thiz.Lcss_classes_package$__f_bitmap$0) << 24) >> 24)
  };
  return $thiz.Lcss_classes_package$__f_DISPLAY_NONE
}
function $p_Lcss_classes_package$__LINER_GRADIENT_DESIGN_BOTTOM_LEFT$lzycompute__T($thiz) {
  if (((((2 & $thiz.Lcss_classes_package$__f_bitmap$0) << 24) >> 24) === 0)) {
    $thiz.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_BOTTOM_LEFT = "linear-gradient-design-bottom-left";
    $thiz.Lcss_classes_package$__f_bitmap$0 = (((2 | $thiz.Lcss_classes_package$__f_bitmap$0) << 24) >> 24)
  };
  return $thiz.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_BOTTOM_LEFT
}
function $p_Lcss_classes_package$__LINER_GRADIENT_DESIGN_TOP_RIGHT$lzycompute__T($thiz) {
  if (((((4 & $thiz.Lcss_classes_package$__f_bitmap$0) << 24) >> 24) === 0)) {
    $thiz.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_TOP_RIGHT = "linear-gradient-design-top-right";
    $thiz.Lcss_classes_package$__f_bitmap$0 = (((4 | $thiz.Lcss_classes_package$__f_bitmap$0) << 24) >> 24)
  };
  return $thiz.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_TOP_RIGHT
}
/** @constructor */
function $c_Lcss_classes_package$() {
  this.Lcss_classes_package$__f_DISPLAY_NONE = null;
  this.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_BOTTOM_LEFT = null;
  this.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_TOP_RIGHT = null;
  this.Lcss_classes_package$__f_bitmap$0 = 0
}
$c_Lcss_classes_package$.prototype = new $h_O();
$c_Lcss_classes_package$.prototype.constructor = $c_Lcss_classes_package$;
/** @constructor */
function $h_Lcss_classes_package$() {
  /*<skip>*/
}
$h_Lcss_classes_package$.prototype = $c_Lcss_classes_package$.prototype;
$c_Lcss_classes_package$.prototype.DISPLAY_NONE__T = (function() {
  return (((((1 & this.Lcss_classes_package$__f_bitmap$0) << 24) >> 24) === 0) ? $p_Lcss_classes_package$__DISPLAY_NONE$lzycompute__T(this) : this.Lcss_classes_package$__f_DISPLAY_NONE)
});
$c_Lcss_classes_package$.prototype.LINER_GRADIENT_DESIGN_BOTTOM_LEFT__T = (function() {
  return (((((2 & this.Lcss_classes_package$__f_bitmap$0) << 24) >> 24) === 0) ? $p_Lcss_classes_package$__LINER_GRADIENT_DESIGN_BOTTOM_LEFT$lzycompute__T(this) : this.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_BOTTOM_LEFT)
});
$c_Lcss_classes_package$.prototype.LINER_GRADIENT_DESIGN_TOP_RIGHT__T = (function() {
  return (((((4 & this.Lcss_classes_package$__f_bitmap$0) << 24) >> 24) === 0) ? $p_Lcss_classes_package$__LINER_GRADIENT_DESIGN_TOP_RIGHT$lzycompute__T(this) : this.Lcss_classes_package$__f_LINER_GRADIENT_DESIGN_TOP_RIGHT)
});
var $d_Lcss_classes_package$ = new $TypeData().initClass({
  Lcss_classes_package$: 0
}, false, "css.classes.package$", {
  Lcss_classes_package$: 1,
  O: 1
});
$c_Lcss_classes_package$.prototype.$classData = $d_Lcss_classes_package$;
var $n_Lcss_classes_package$;
function $m_Lcss_classes_package$() {
  if ((!$n_Lcss_classes_package$)) {
    $n_Lcss_classes_package$ = new $c_Lcss_classes_package$()
  };
  return $n_Lcss_classes_package$
}
/** @constructor */
function $c_Lhandler_ContainerEventHandler$() {
  /*<skip>*/
}
$c_Lhandler_ContainerEventHandler$.prototype = new $h_O();
$c_Lhandler_ContainerEventHandler$.prototype.constructor = $c_Lhandler_ContainerEventHandler$;
/** @constructor */
function $h_Lhandler_ContainerEventHandler$() {
  /*<skip>*/
}
$h_Lhandler_ContainerEventHandler$.prototype = $c_Lhandler_ContainerEventHandler$.prototype;
$c_Lhandler_ContainerEventHandler$.prototype.handleButtonClickEvent__V = (function() {
  var bodyClassList = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().querySelector("body").classList;
  bodyClassList.toggle($m_Lcss_classes_package$().LINER_GRADIENT_DESIGN_BOTTOM_LEFT__T());
  bodyClassList.toggle($m_Lcss_classes_package$().LINER_GRADIENT_DESIGN_TOP_RIGHT__T());
  var $$x1 = $m_Llogger_Logger$();
  var array = ["Gradient designed changed"];
  $n($$x1).info__sci_Seq__V(new $c_sjsr_WrappedVarArgs(array))
});
var $d_Lhandler_ContainerEventHandler$ = new $TypeData().initClass({
  Lhandler_ContainerEventHandler$: 0
}, false, "handler.ContainerEventHandler$", {
  Lhandler_ContainerEventHandler$: 1,
  O: 1
});
$c_Lhandler_ContainerEventHandler$.prototype.$classData = $d_Lhandler_ContainerEventHandler$;
var $n_Lhandler_ContainerEventHandler$;
function $m_Lhandler_ContainerEventHandler$() {
  if ((!$n_Lhandler_ContainerEventHandler$)) {
    $n_Lhandler_ContainerEventHandler$ = new $c_Lhandler_ContainerEventHandler$()
  };
  return $n_Lhandler_ContainerEventHandler$
}
/** @constructor */
function $c_Lhandler_WindowEventHandler$() {
  /*<skip>*/
}
$c_Lhandler_WindowEventHandler$.prototype = new $h_O();
$c_Lhandler_WindowEventHandler$.prototype.constructor = $c_Lhandler_WindowEventHandler$;
/** @constructor */
function $h_Lhandler_WindowEventHandler$() {
  /*<skip>*/
}
$h_Lhandler_WindowEventHandler$.prototype = $c_Lhandler_WindowEventHandler$.prototype;
$c_Lhandler_WindowEventHandler$.prototype.onLoadHandler__V = (function() {
  $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().alert("Web page loaded successfully.");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().querySelector("#container").classList.remove($m_Lcss_classes_package$().DISPLAY_NONE__T());
  var $$x1 = $m_Llogger_Logger$();
  var array = ["Web page loaded successfully."];
  $n($$x1).info__sci_Seq__V(new $c_sjsr_WrappedVarArgs(array))
});
var $d_Lhandler_WindowEventHandler$ = new $TypeData().initClass({
  Lhandler_WindowEventHandler$: 0
}, false, "handler.WindowEventHandler$", {
  Lhandler_WindowEventHandler$: 1,
  O: 1
});
$c_Lhandler_WindowEventHandler$.prototype.$classData = $d_Lhandler_WindowEventHandler$;
var $n_Lhandler_WindowEventHandler$;
function $m_Lhandler_WindowEventHandler$() {
  if ((!$n_Lhandler_WindowEventHandler$)) {
    $n_Lhandler_WindowEventHandler$ = new $c_Lhandler_WindowEventHandler$()
  };
  return $n_Lhandler_WindowEventHandler$
}
/** @constructor */
...
/** @constructor */
function $c_Llogger_Logger$() {
  /*<skip>*/
}
$c_Llogger_Logger$.prototype = new $h_O();
$c_Llogger_Logger$.prototype.constructor = $c_Llogger_Logger$;
/** @constructor */
function $h_Llogger_Logger$() {
  /*<skip>*/
}
$h_Llogger_Logger$.prototype = $c_Llogger_Logger$.prototype;
$c_Llogger_Logger$.prototype.info__sci_Seq__V = (function(messages) {
  var this$2 = $n($as_sc_IterableOnceOps($n(messages).map__F1__O(new $c_sjsr_AnonFunction1(((x$1$2) => $dp_toString__T($n(x$1$2)))))));
...
var $d_Llogger_Logger$ = new $TypeData().initClass({
  Llogger_Logger$: 0
}, false, "logger.Logger$", {
  Llogger_Logger$: 1,
  O: 1
});
$c_Llogger_Logger$.prototype.$classData = $d_Llogger_Logger$;
var $n_Llogger_Logger$;
function $m_Llogger_Logger$() {
  if ((!$n_Llogger_Logger$)) {
    $n_Llogger_Logger$ = new $c_Llogger_Logger$()
  };
  return $n_Llogger_Logger$
}
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
handleContainerButtonClickEvent = (function() {
  $m_Lhandler_ContainerEventHandler$().handleButtonClickEvent__V()
});
onLoadHandler = (function() {
  $m_Lhandler_WindowEventHandler$().onLoadHandler__V()
});
}).call(this);
//# sourceMappingURL=crossproject-fastopt.js.map
